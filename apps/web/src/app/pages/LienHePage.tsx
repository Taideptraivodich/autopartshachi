...
const LienHePage: React.FC = () => {
  ...
  if (state === 'success') {
    return (
      <>
        <MetaTags title="Liên hệ" description="Liên hệ với Hachi để được tư vấn phụ tùng ô tô chính hãng." />
        <div className="container">
          <div style={{ padding: 'var(--space-6) 0' }}>
            <Breadcrumb items={[{ label: 'Trang chủ', href: '/' }, { label: 'Liên hệ' }]} />
          </div>
          <div style={{ maxWidth: 480, margin: '0 auto', textAlign: 'center', padding: 'var(--space-12) var(--space-4)' }}>
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div style={{ maxWidth: 560, margin: '0 auto', paddingBottom: 'var(--space-12)' }}>
          ...
          <p style={{ color: 'var(--color-text-secondary)', marginBottom: 'var(--space-6)', lineHeight: 1.6 }}>
            Để lại thông tin — đội ngũ Hachi sẽ gọi lại tư vấn và báo giá trong vòng 24 giờ làm việc.
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
            ...
            <button
              ...
              disabled={state === 'submitting' || !name.trim() || !phone.trim() || !message.trim()}
              style={{
                padding: 'var(--space-3) var(--space-5)',
                background: 'var(--color-primary)',
                color: '#fff',
                ...
                opacity: (state === 'submitting' || !name.trim() || !phone.trim() || !message.trim()) ? 0.6 : 1,
